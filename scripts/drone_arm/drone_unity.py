...
from px4_control.srv import UnityGetState, UnityGetStateRequest, UnitySetState, UnitySetStateRequest
...
class Drone:
    def __init__(self):
        ...
        self.unity_state = UnityGetStateRequest.ONGROUND
        ...
        self.unity_get_state_client = rospy.ServiceProxy('/unity/get_state', UnityGetState)
        self.unity_set_state_client = rospy.ServiceProxy('/unity/get_state', UnitySetState)

...
def landing():
    ...
    while sp.pose.position.z > -0.5 and not rospy.is_shutdown():
        ...
        imp_pose, imp_vel, imp_time_prev = impedance_modeles.distance_impedance(sp.pose.position.z, imp_pose_prev, imp_vel_prev, imp_time_prev)
...
if __name__ == '__main__':
    try:
        ...
        try:
            ...
            h_des = 1.5; t_hold = 3.0
            print("Desired altitude: %d m; holding time: %d sec" %(h_des, t_hold))
